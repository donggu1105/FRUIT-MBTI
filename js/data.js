...
const mbtiInfo = {
  ...
  "ISTP": {
    nickName : '<키위>',
    color : '#70D907',
    desc: '껍질속에 숨기고 있는 다재다능 끼쟁이 <b>키위</b>',
  ...
  "ESFP": {
    nickName : '<체리>',
    color : '#D96B8C',
    desc: '세상은 놀거 투성이! 정신들 체리라.. <b>체리</b>',
  ...
  "INFJ": {
    nickName : '<파인애플>',
    color : '#E2D23A',
    desc: '철벽이지만 알고 보면 겉바 속촉인 <b>파인애플</b>',
  ...
  "INFP": {
    ...
    "ENFJ": {
        nickName : '<복숭아>',
        color : '#DF9CE0',
        desc: '부드러움과 단단함을 가진 지도자 <b>복숭아</b>',
    ...
    "INTP": {
        nickName : '<레몬>',
        color : '#DDD400',
        desc: '사색 의 세계에 빠지고 싶은 시큼한 <b>레몬</b>',
