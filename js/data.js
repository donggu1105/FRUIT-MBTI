...
const mbtiInfo = {
  ...
  "ESTP": {
    nickName : '<코코넛>',
    desc: '여행을 나서기 좋아하는 엄청난 활동가! 당신은 코코넛!',
  ...
  "ESTJ": {
    nickName : '<수박>',
    desc: '커다란 무게감으로 많은 사람들을 아우르는 당신은 수박!',
  ...
  "ISFJ": {
    nickName : '<귤>',
    desc: '차가운 단톡방의 비타민은 귤이 책임진다! ',
    content: ["내향적이면서 외향적인 성격이 묻어나요! 나서는 성격은 아니에요 하지만 관심받는것은 오히려 좋아..?",
              "활성화 단톡방은 주로 소수!\n" +
              "여러 사람 많이 만나기 보다는 찐으로 친한 인맥을 만들어요! 소수의 단톡방을 선호해요!",
              "연락이 안될 때 주로 자고있어요!",
  ...
  "ISFP": {
    nickName : '<딸기>',
    desc: '귀찮아..톡이 너무 많이 왔어… 알딸 딸-기절하겠네..!',
